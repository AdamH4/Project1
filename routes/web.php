...
Route::post('/cart/card', 'CartController@card')->name('cart.card');
...
//Route::post('/language/en', 'LanguageController@en')->name('language.en');
//Route::post('/language/sk', 'LanguageController@sk')->name('language.sk');
